...
export default function Footer() {
    return (
        <footer className="bg-gray-600 shadow dark:bg-gray-900">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center mb-4 sm:mb-0">
                        <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">Slide-Generator</span>
                    </div>
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-white sm:mb-0 dark:text-gray-400">
                        ...
                        <li>
                            <Link href="https://www.instagram.com" className="mr-4 hover:underline md:mr-6 ">
